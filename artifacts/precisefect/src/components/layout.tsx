    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 border-b border-transparent ${isScrolled ? "bg-background/80 backdrop-blur-[24px] border-border shadow-sm py-4" : "bg-transparent py-6"}`}>
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/contact">
            <button className="signature-gradient text-white font-bold rounded-lg px-8 py-3 shadow-sm btn-press">Consultation</button>
          </Link>
        </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <Link href="/contact" className="pt-4">
              <button className="w-full signature-gradient text-white font-bold rounded-lg px-8 py-3 btn-press">Consultation</button>
            </Link>
          </motion.div>
        )}
      </AnimatePresence>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="pt-4">
                <Link href="/contact"><span className="text-sm font-bold text-white hover:text-on-primary-container transition-colors">Submit RFP &rarr;</span></Link>
              </li>
            </ul>
          </div>
        </div>
